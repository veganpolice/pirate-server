  ...
  return knex('ships').del()
    .then(function () {
      ...
      return knex('ships').insert([
        ...
        {id: 3, name: "bass-cannos", active: false, path: 'no path', user_id: 3, current_track: 0, current_position_millis: 0, is_paused: true, time_stamp: Date.now(), pimg: '', crew: 0},
        {id: 4, name: "sinking-songs", active: false, path: 'no path', user_id: 4, current_track: 0, current_position_millis: 0, is_paused: true, time_stamp: Date.now(), pimg: '', crew: 0},
      ]);
    });
};
